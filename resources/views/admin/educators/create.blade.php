...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('educator.register.submit') }}" method="POST">
                @csrf
                ...
                <div class="d-flex justify-content-between">
                    <a href="{{ route('admin.educators.index') }}" class="btn btn-secondary">Cancel</a>
                    <button type="submit" class="btn btn-primary">Create Educator</button>
                </div>
            </form>
        </div>
    </div>
