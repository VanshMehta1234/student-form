...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Educator Registration') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('educator.register.submit') }}">
                        @csrf
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a class="btn btn-link" href="{{ route('educator.login.form') }}">
