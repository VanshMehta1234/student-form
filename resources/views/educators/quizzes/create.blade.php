    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('educator.quizzes.store') }}">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="time_limit" type="number" min="1" class="form-control @error('time_limit') is-invalid @enderror" name="time_limit" value="{{ old('time_limit') }}" placeholder="Leave empty for no time limit">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="passing_score" type="number" min="0" max="100" class="form-control @error('passing_score') is-invalid @enderror" name="passing_score" value="{{ old('passing_score', 70) }}" required>
